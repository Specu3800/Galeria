				...
				<div class='form' style='text-align: center;'>
					<table style='width: 100%; text-align: center;'>
						<tr> 
							...
							<td>
								<form action='index.php?page=admin&admin-page=admin-albumy&delete=$id_albumu' method='post'>
								<input class='button' type='submit' value ='Usuń' onclick=\"return confirm('Jesteś pewny, ze chcesz usunąć album o nazwie: $tytul?')\">
								</form>
							</td>
						</tr>
						<tr>
							<form action='index.php?page=admin&admin-page=admin-albumy&change=$id_albumu' method='post'>
								<td>
...
//Usuwanie i zmiana nazwy
	if(isset($_GET['delete'])){
		...
		header ('location: index.php?page=admin&admin-page=admin-albumy');
	}	
	...
	<div class="page">
		<?php
			...
			for ($i = 1; $i<=$pagesAmount; $i++){
				...
				echo "class='page-button' href='index.php?page=admin&admin-page=admin-albumy&strona=$i'>$i</a>-";}
			echo '-</div>';
