					...
					<table style='width: 100%; text-align: center;'>
						<tr > 
							...
							<td style='width: 180px;'>
								<form action='index.php?page=konto&konto-page=konto-foto&delete=$id_zdj' method='post'>
								<input class='button' type='submit' value ='Usuń' onclick=\"return confirm('Jesteś pewny, ze chcesz usunąć zdjęcie o nazwie: $tytul?')\">
								</form>			
							</td>
						</tr>
						<tr > 
							<form action='index.php?page=konto&konto-page=konto-foto&change=$id_zdj' method='post'>
								<td>
...
//Usuwanie i zmiana nazwy
	if(isset($_GET['delete'])){
		...
		header ('location: index.php?page=konto&konto-page=konto-foto');
	}	
	...
	<div class="page">
		<?php
			...
			for ($i = 1; $i<=$pagesAmount; $i++){
				...
				echo "class='page-button' href='index.php?page=konto&konto-page=konto-foto&strona=$i'>$i</a>-";}
			echo '-</div>';
